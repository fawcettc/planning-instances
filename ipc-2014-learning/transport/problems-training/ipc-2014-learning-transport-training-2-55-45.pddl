; Transport two-cities-sequential-55nodes-1000size-4degree-100mindistance-4trucks-45packages-2013seed
(define (problem transport-two-cities-sequential-55nodes-1000size-4degree-100mindistance-4trucks-45packages-2013seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (at package-36 city-1-loc-13)
  (at package-37 city-1-loc-52)
  ...
  (at package-43 city-1-loc-45)
  (at package-44 city-1-loc-19)
  (at package-45 city-1-loc-14)
  (at truck-1 city-2-loc-54)
 ...
 (:goal (and
  ...
  (at package-30 city-2-loc-32)
  (at package-31 city-2-loc-42)
  (at package-32 city-2-loc-29)
  ...
  (at package-39 city-2-loc-34)
  (at package-40 city-2-loc-32)
  (at package-41 city-2-loc-13)
  (at package-42 city-2-loc-44)
  (at package-43 city-2-loc-29)
  (at package-44 city-2-loc-50)
  (at package-45 city-2-loc-54)
 ))
