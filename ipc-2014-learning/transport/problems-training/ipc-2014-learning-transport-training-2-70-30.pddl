; Transport two-cities-sequential-70nodes-1000size-4degree-100mindistance-4trucks-30packages-2013seed
(define (problem transport-two-cities-sequential-70nodes-1000size-4degree-100mindistance-4trucks-30packages-2013seed)
 (:domain transport)
 (:objects
