; Transport three-cities-sequential-70nodes-1000size-4degree-100mindistance-4trucks-35packages-2013seed
(define (problem transport-three-cities-sequential-70nodes-1000size-4degree-100mindistance-4trucks-35packages-2013seed)
 (:domain transport)
 (:objects
 ...
 (:goal (and
  ...
  (at package-32 city-3-loc-26)
  (at package-33 city-3-loc-55)
