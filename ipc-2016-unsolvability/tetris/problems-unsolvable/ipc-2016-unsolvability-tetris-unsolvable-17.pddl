(define (problem Tetris-8-4-5411814)
(:domain tetris)
(:objects
...
(clear f7-2f)
(clear f7-3f)
(at_right_l rightl0 f3-1f f4-1f f4-2f)
(at_right_l rightl1 f0-1f f1-1f f1-2f)
(at_right_l rightl2 f2-2f f3-2f f3-3f)
(at_two straight0 f7-1f f7-0f)
(at_two straight1 f5-2f f5-1f)
(at_two straight2 f6-1f f6-0f)
(at_square square0 f5-0f)
(at_square square1 f2-3f)
(at_square square2 f6-2f)
)
(:goal
(and
(clear f0-0f)
