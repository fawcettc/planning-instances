(define (problem roverprob--s1026--m25--r2--w10--o6--c6--g5--p0--P1--C9) (:domain Rover)
(:objects
    general - Lander
    ...
    level0 level1 level2 level3 level4 level5 level6 level7 level8 level9 level10 level11 level12 level13 level14 level15 level16 level17 level18 level19 level20 level21 level22 level23 level24 level25 level26 level27 level28 level29 level30 level31 level32 level33 level34 level35 level36 - energylevel
    )
(:init
    ...
    (energycost level4 waypoint0 waypoint9)
    (energycost level4 waypoint9 waypoint0)
    (energycost level25 waypoint1 waypoint2)
    (energycost level25 waypoint2 waypoint1)
    (energycost level15 waypoint1 waypoint3)
    (energycost level15 waypoint3 waypoint1)
    (energycost level17 waypoint1 waypoint4)
    (energycost level17 waypoint4 waypoint1)
    ...
    (energycost level8 waypoint1 waypoint7)
    (energycost level8 waypoint7 waypoint1)
    (energycost level24 waypoint2 waypoint5)
    (energycost level24 waypoint5 waypoint2)
    (energycost level8 waypoint2 waypoint6)
    (energycost level8 waypoint6 waypoint2)
    (energycost level11 waypoint2 waypoint7)
    (energycost level11 waypoint7 waypoint2)
    (energycost level20 waypoint2 waypoint8)
    (energycost level20 waypoint8 waypoint2)
    (energycost level20 waypoint2 waypoint9)
    (energycost level20 waypoint9 waypoint2)
    (energycost level3 waypoint3 waypoint6)
    (energycost level3 waypoint6 waypoint3)
    (energycost level16 waypoint4 waypoint7)
    (energycost level16 waypoint7 waypoint4)
    (energycost level5 waypoint4 waypoint9)
    (energycost level5 waypoint9 waypoint4)
    (energycost level14 waypoint5 waypoint6)
    (energycost level14 waypoint6 waypoint5)
    ...
    (energycost level21 waypoint8 waypoint9)
    (energycost level21 waypoint9 waypoint8)
