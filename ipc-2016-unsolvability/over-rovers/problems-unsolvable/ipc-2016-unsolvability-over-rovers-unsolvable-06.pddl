(define (problem roverprob--s1026--m25--r2--w8--o5--c5--g5--p0--P1--C9) (:domain Rover)
(:objects
    general - Lander
    ...
    level0 level1 level2 level3 level4 level5 level6 level7 level8 level9 level10 level11 level12 level13 level14 level15 level16 level17 level18 level19 level20 level21 level22 level23 level24 level25 level26 level27 level28 level29 level30 level31 level32 level33 level34 level35 level36 level37 level38 level39 level40 level41 level42 level43 level44 level45 level46 level47 - energylevel
    )
(:init
    ...
    (energycost level21 waypoint0 waypoint6)
    (energycost level21 waypoint6 waypoint0)
    (energycost level12 waypoint0 waypoint7)
    (energycost level12 waypoint7 waypoint0)
    ...
    (energycost level8 waypoint2 waypoint4)
    (energycost level8 waypoint4 waypoint2)
    (energycost level14 waypoint2 waypoint5)
    (energycost level14 waypoint5 waypoint2)
    ...
    (energycost level15 waypoint4 waypoint5)
    (energycost level15 waypoint5 waypoint4)
    ...
    (energycost level22 waypoint5 waypoint6)
    (energycost level22 waypoint6 waypoint5)
    (energycost level11 waypoint5 waypoint7)
    (energycost level11 waypoint7 waypoint5)
