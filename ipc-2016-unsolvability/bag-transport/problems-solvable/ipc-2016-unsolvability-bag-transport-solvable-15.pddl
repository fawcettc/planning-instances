...
(:init (road city-1-loc-1 city-3-loc-3)
...
(count-package package-bag1 city-3-loc-4 pnum2)
(count-package package-bag2 city-1-loc-3 pnum2)
(count-package package-bag3 city-2-loc-5 pnum1)
(count-package package-bag4 city-3-loc-2 pnum1)
(count-package package-bag5 city-1-loc-1 pnum1)
(count-package package-bag6 city-2-loc-2 pnum1)
...
(:goal (and
      (count-package package-bag1 city-1-loc-5 pnum1)
      (count-package package-bag1 city-3-loc-2 pnum1)
      (count-package package-bag2 city-1-loc-4 pnum1)
      (count-package package-bag2 city-2-loc-5 pnum1)
      (count-package package-bag3 city-2-loc-1 pnum1)
      (count-package package-bag4 city-1-loc-3 pnum1)
      (count-package package-bag5 city-3-loc-1 pnum1)
      (count-package package-bag6 city-3-loc-4 pnum1)
      (count-package package-bag7 city-2-loc-4 pnum1))
)
