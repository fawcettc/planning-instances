(define (problem tpp-problem-m6-g3-c0.5-s1026)
...
(:objects
    ...
    level33 level32 level31 level30 level29 level28 level27 level26 level25 level24 level23 level22 level21 level20 level19 level18 level17 level16 level15 level14 level13 level12 level11 level10 level9 level8 level7 level6 level5 level4 level3 level2 level1 level0 - moneylevel
)
(:init
    ...
    (drive-cost market1 market4 level14)
    (connected market1 market4)
    (drive-cost market1 market6 level17)
    ...
    (drive-cost market4 market1 level14)
    ...
    (drive-cost market6 market1 level17)
