(define (problem prob)
(:domain barman)
(:init (cocktail-part1 cocktail6 ingredient3)
...
(count-shot-goal-desired-count shot-bag1 cocktail3 snum3)
...
(count-shot-goal-desired-count shot-bag1 ingredient1 snum1)
...
(:goal (and
      ...
      (count-shot-goal-satisfied shot-bag1 ingredient1))
)
