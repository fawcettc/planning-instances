...
(count-shot-goal-desired-count shot-bag1 cocktail6 snum3)
...
(count-shot-goal-desired-count shot-bag1 ingredient3 snum1)
...
(:goal (and
      ...
      (count-shot-goal-satisfied shot-bag1 ingredient3))
)
