...
hand-bag1  - hand
snum1 snum2 snum3 snum4 snum5 snum6 snum7 snum8 snum9 snum0  - snum
...
(:action empty-shot-cocktail7-N
    ...
    :precondition (and
      (count-shot ?p ?h ?dc cocktail7 ?n1)
      (shot-less ?n0 ?n1)
      ...
      (hand-less ?n5 ?n4)
      (shot-less ?n0_1 ?n1_1)
      (count-shot-goal ?p cocktail7 ?n1_1)
      (not (= ?n1_1 ?des))
      (count-shot-goal-desired-count ?p cocktail7 ?des)
      (shot-lte-sum ?n1 ?n2 ?p-size)
      (shot-bag-size ?p ?p-size))
    :effect (and
      (count-shot ?p ?h ?dc cocktail7 ?n0)
      (not (count-shot ?p ?h ?dc cocktail7 ?n1))
      (count-shot ?p ?h ?dc empty-shot-true ?n3)
      (not (count-shot ?p ?h ?dc empty-shot-true ?n2))
      (count-shot-goal ?p cocktail7 ?n0_1)
      (not (count-shot-goal ?p cocktail7 ?n1_1))
(increase (total-cost ) 1)))
(:action empty-shot-cocktail7-D
    ...
    :precondition (and
      ...
      (shot-less ?n0_1 ?n1_1)
      (count-shot-goal ?p cocktail7 ?n1_1)
      (count-shot-goal-desired-count ?p cocktail7 ?n1_1)
      (shot-lte-sum ?n1 ?n2 ?p-size)
      (shot-bag-size ?p ?p-size))
    :effect (and
      (count-shot ?p ?h ?dc cocktail7 ?n0)
      ...
      (count-shot-goal ?p cocktail7 ?n0_1)
      (not (count-shot-goal ?p cocktail7 ?n1_1))
      (not (count-shot-goal-satisfied ?p cocktail7))
(increase (total-cost ) 1)))
...
(:action empty-shot
    ...
    :effect (and
      ...
      (not (count-shot ?p ?h ?dc empty-shot-true ?n2))
(increase (total-cost ) 1)))
(:action pour-shaker-to-shot-cocktail7-N
    ...
    :precondition (and
      ...
      (shot-less ?n0 ?n1)
      (count-shot ?d ?dc shot-property2-none cocktail7 ?n2)
      (shot-less ?n2 ?n3)
      (count-hand ?h ?s ?n4)
      (hand-less ?n5 ?n4)
      (shaked ?s)
      (contains-shaker ?s cocktail7)
      (shaker-level ?s ?l)
      (next ?l1 ?l)
      (shot-less ?n2_1 ?n3_1)
      (count-shot-goal ?d cocktail7 ?n2_1)
      (not (= ?n3_1 ?des))
      (count-shot-goal-desired-count ?d cocktail7 ?des)
    ...
    :effect (and
      ...
      (count-shot ?d ?dc shot-property2-none cocktail7 ?n3)
      (not (count-shot ?d ?dc shot-property2-none cocktail7 ?n2))
      (shaker-level ?s ?l1)
      (not (shaker-level ?s ?l))
      (count-shot-goal ?d cocktail7 ?n3_1)
      (not (count-shot-goal ?d cocktail7 ?n2_1))
(increase (total-cost ) 1)))
(:action pour-shaker-to-shot-cocktail7-U
    ...
    :precondition (and
      ...
      (shot-less ?n2_1 ?n3_1)
      (count-shot-goal ?d cocktail7 ?n2_1)
      (count-shot-goal-desired-count ?d cocktail7 ?n3_1)
      (shot-lte-sum ?n1 ?n2 ?d-size)
      (shot-bag-size ?d ?d-size))
    :effect (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n0)
      ...
      (count-shot-goal ?d cocktail7 ?n3_1)
      (not (count-shot-goal ?d cocktail7 ?n2_1))
      (count-shot-goal-satisfied ?d cocktail7)
(increase (total-cost ) 1)))
