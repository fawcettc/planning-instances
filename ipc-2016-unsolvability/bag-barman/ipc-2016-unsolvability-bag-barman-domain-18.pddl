...
(:action empty-shot-cocktail7-N
    ...
    :precondition (and
      (count-hand ?h ?p ?n1)
      (hand-less ?n0 ?n1)
      (count-shot ?p ?h ?dc cocktail7 ?n2)
      (shot-less ?n3 ?n2)
      (count-shot ?p ?h ?dc empty-shot-true ?n4)
      (shot-less ?n4 ?n5)
      (shot-less ?n3_1 ?n2_1)
      (count-shot-goal ?p cocktail7 ?n2_1)
      (not (= ?n2_1 ?des))
      (count-shot-goal-desired-count ?p cocktail7 ?des)
      (shot-lte-sum ?n2 ?n4 ?p-size)
      (shot-bag-size ?p ?p-size))
    :effect (and
      (count-shot ?p ?h ?dc cocktail7 ?n3)
      (not (count-shot ?p ?h ?dc cocktail7 ?n2))
      (count-shot ?p ?h ?dc empty-shot-true ?n5)
      (not (count-shot ?p ?h ?dc empty-shot-true ?n4))
      (count-shot-goal ?p cocktail7 ?n3_1)
      (not (count-shot-goal ?p cocktail7 ?n2_1))
(increase (total-cost ) 1)))
(:action empty-shot-cocktail7-D
    ...
    :precondition (and
      ...
      (shot-less ?n3_1 ?n2_1)
      (count-shot-goal ?p cocktail7 ?n2_1)
      (count-shot-goal-desired-count ?p cocktail7 ?n2_1)
      (shot-lte-sum ?n2 ?n4 ?p-size)
      (shot-bag-size ?p ?p-size))
    :effect (and
      (count-shot ?p ?h ?dc cocktail7 ?n3)
...
(:action pour-shaker-to-shot-cocktail7-N
    ...
    :precondition (and
      ...
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n2)
      (shot-less ?n3 ?n2)
      (count-shot ?d ?dc shot-property2-none cocktail7 ?n4)
      (shot-less ?n4 ?n5)
      (shaked ?s)
      ...
      (next ?l1 ?l)
      (shot-less ?n4_1 ?n5_1)
      (count-shot-goal ?d cocktail7 ?n4_1)
      (not (= ?n5_1 ?des))
    ...
    :effect (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n3)
      (not (count-shot ?d ?dc clean-shot-true empty-shot-true ?n2))
      (count-shot ?d ?dc shot-property2-none cocktail7 ?n5)
      (not (count-shot ?d ?dc shot-property2-none cocktail7 ?n4))
      (shaker-level ?s ?l1)
      (not (shaker-level ?s ?l))
      (count-shot-goal ?d cocktail7 ?n5_1)
      (not (count-shot-goal ?d cocktail7 ?n4_1))
(increase (total-cost ) 1)))
(:action pour-shaker-to-shot-cocktail7-U
    ...
    :precondition (and
      ...
      (shot-less ?n4_1 ?n5_1)
      (count-shot-goal ?d cocktail7 ?n4_1)
      (count-shot-goal-desired-count ?d cocktail7 ?n5_1)
      (shot-lte-sum ?n2 ?n4 ?d-size)
      (shot-bag-size ?d ?d-size))
    :effect (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n3)
