...
(:action shake
    ...
    :effect (and
      ...
      (contains-shaker ?s ?b)
(increase (total-cost ) 1)))
(:action fill-shot-ingredient3-N
    :parameters (?s - shot ?h1 - hand ?h2 - hand ?d - dispenser ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n6 - hnum ?n7 - hnum ?n2_1 - snum ?n3_1 - snum ?des - snum ?s-size - snum)
    :precondition (and
      (count-shot ?s ?h1 clean-shot-true empty-shot-true ?n1)
      (shot-less ?n0 ?n1)
      (count-shot ?s ?h1 ingredient3 ingredient3 ?n2)
      (shot-less ?n2 ?n3)
      (count-hand ?h1 ?s ?n4)
      (hand-less ?n5 ?n4)
      (count-hand ?h2 handempty-true ?n6)
      (hand-less ?n7 ?n6)
      (dispenses ?d ingredient3)
      (shot-less ?n2_1 ?n3_1)
      (count-shot-goal ?s ingredient3 ?n2_1)
      (not (= ?n3_1 ?des))
      (count-shot-goal-desired-count ?s ingredient3 ?des)
      (shot-lte-sum ?n1 ?n2 ?s-size)
      (shot-bag-size ?s ?s-size))
    :effect (and
      (count-shot ?s ?h1 clean-shot-true empty-shot-true ?n0)
      (not (count-shot ?s ?h1 clean-shot-true empty-shot-true ?n1))
      (count-shot ?s ?h1 ingredient3 ingredient3 ?n3)
      (not (count-shot ?s ?h1 ingredient3 ingredient3 ?n2))
      (count-shot-goal ?s ingredient3 ?n3_1)
      (not (count-shot-goal ?s ingredient3 ?n2_1))
(increase (total-cost ) 10)))
(:action fill-shot-ingredient3-U
    :parameters (?s - shot ?h1 - hand ?h2 - hand ?d - dispenser ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n6 - hnum ?n7 - hnum ?n2_1 - snum ?n3_1 - snum ?s-size - snum)
    :precondition (and
      (count-shot ?s ?h1 clean-shot-true empty-shot-true ?n1)
      (shot-less ?n0 ?n1)
      (count-shot ?s ?h1 ingredient3 ingredient3 ?n2)
      ...
      (shot-less ?n2_1 ?n3_1)
      (count-shot-goal ?s ingredient3 ?n2_1)
      (count-shot-goal-desired-count ?s ingredient3 ?n3_1)
      (shot-lte-sum ?n1 ?n2 ?s-size)
      (shot-bag-size ?s ?s-size))
    :effect (and
      (count-shot ?s ?h1 clean-shot-true empty-shot-true ?n0)
      ...
      (count-shot-goal ?s ingredient3 ?n3_1)
      (not (count-shot-goal ?s ingredient3 ?n2_1))
      (count-shot-goal-satisfied ?s ingredient3)
(increase (total-cost ) 10)))
(:action fill-shot
    :parameters (?s - shot ?i - ingredient ?h1 - hand ?h2 - hand ?d - dispenser ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n6 - hnum ?n7 - hnum ?s-size - snum)
    :precondition (and
...
(:action empty-shot-cocktail6-N
    ...
    :precondition (and
      (count-shot ?p ?h ?dc cocktail6 ?n1)
      (shot-less ?n0 ?n1)
...
(:action empty-shot-cocktail6-D
    ...
    :precondition (and
      ...
      (shot-less ?n0_1 ?n1_1)
      (count-shot-goal ?p cocktail6 ?n1_1)
      (count-shot-goal-desired-count ?p cocktail6 ?n1_1)
      (shot-lte-sum ?n1 ?n2 ?p-size)
      (shot-bag-size ?p ?p-size))
    :effect (and
      (count-shot ?p ?h ?dc cocktail6 ?n0)
...
(increase (total-cost ) 1)))
(:action empty-shot-ingredient3-N
    :parameters (?h - hand ?p - shot ?dc - object ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n0_1 - snum ?n1_1 - snum ?des - snum ?p-size - snum)
    :precondition (and
      (count-shot ?p ?h ?dc ingredient3 ?n1)
      (shot-less ?n0 ?n1)
      (count-shot ?p ?h ?dc empty-shot-true ?n2)
      (shot-less ?n2 ?n3)
      (count-hand ?h ?p ?n4)
      (hand-less ?n5 ?n4)
      (shot-less ?n0_1 ?n1_1)
      (count-shot-goal ?p ingredient3 ?n1_1)
      (not (= ?n1_1 ?des))
      (count-shot-goal-desired-count ?p ingredient3 ?des)
      (shot-lte-sum ?n1 ?n2 ?p-size)
      (shot-bag-size ?p ?p-size))
    :effect (and
      (count-shot ?p ?h ?dc ingredient3 ?n0)
      (not (count-shot ?p ?h ?dc ingredient3 ?n1))
      (count-shot ?p ?h ?dc empty-shot-true ?n3)
      (not (count-shot ?p ?h ?dc empty-shot-true ?n2))
      (count-shot-goal ?p ingredient3 ?n0_1)
      (not (count-shot-goal ?p ingredient3 ?n1_1))
(increase (total-cost ) 1)))
(:action empty-shot-ingredient3-D
    :parameters (?h - hand ?p - shot ?dc - object ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n0_1 - snum ?n1_1 - snum ?p-size - snum)
    :precondition (and
      (count-shot ?p ?h ?dc ingredient3 ?n1)
      (shot-less ?n0 ?n1)
      ...
      (shot-less ?n0_1 ?n1_1)
      (count-shot-goal ?p ingredient3 ?n1_1)
      (count-shot-goal-desired-count ?p ingredient3 ?n1_1)
      (shot-lte-sum ?n1 ?n2 ?p-size)
      (shot-bag-size ?p ?p-size))
    :effect (and
      (count-shot ?p ?h ?dc ingredient3 ?n0)
      ...
      (count-shot-goal ?p ingredient3 ?n0_1)
      (not (count-shot-goal ?p ingredient3 ?n1_1))
      (not (count-shot-goal-satisfied ?p ingredient3))
(increase (total-cost ) 1)))
(:action empty-shot
    ...
    :effect (and
      ...
      (not (count-shot ?p ?h ?dc empty-shot-true ?n2))
(increase (total-cost ) 1)))
(:action pour-shot-to-clean-shaker-ingredient3-N
    :parameters (?s - shot ?d - shaker ?h1 - hand ?l - level ?l1 - level ?dc - object ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n0_1 - snum ?n1_1 - snum ?des - snum ?s-size - snum)
    :precondition (and
      (count-shot ?s ?h1 ?dc ingredient3 ?n1)
      (shot-less ?n0 ?n1)
      ...
      (next ?l ?l1)
      (shot-less ?n0_1 ?n1_1)
      (count-shot-goal ?s ingredient3 ?n1_1)
      (not (= ?n1_1 ?des))
      (count-shot-goal-desired-count ?s ingredient3 ?des)
      (shot-lte-sum ?n1 ?n2 ?s-size)
      (shot-bag-size ?s ?s-size))
    :effect (and
      (count-shot ?s ?h1 ?dc ingredient3 ?n0)
      (not (count-shot ?s ?h1 ?dc ingredient3 ?n1))
      (count-shot ?s ?h1 ?dc empty-shot-true ?n3)
      (not (count-shot ?s ?h1 ?dc empty-shot-true ?n2))
      (contains-shaker ?d ingredient3)
      (not (empty-shaker ?d))
      (not (clean-shaker ?d))
      (unshaked ?d)
      (not (shaker-level ?d ?l))
      (shaker-level ?d ?l1)
      (count-shot-goal ?s ingredient3 ?n0_1)
      (not (count-shot-goal ?s ingredient3 ?n1_1))
(increase (total-cost ) 1)))
(:action pour-shot-to-clean-shaker-ingredient3-D
    :parameters (?s - shot ?d - shaker ?h1 - hand ?l - level ?l1 - level ?dc - object ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n0_1 - snum ?n1_1 - snum ?s-size - snum)
    :precondition (and
      (count-shot ?s ?h1 ?dc ingredient3 ?n1)
      (shot-less ?n0 ?n1)
      (count-shot ?s ?h1 ?dc empty-shot-true ?n2)
      ...
      (shot-less ?n0_1 ?n1_1)
      (count-shot-goal ?s ingredient3 ?n1_1)
      (count-shot-goal-desired-count ?s ingredient3 ?n1_1)
      (shot-lte-sum ?n1 ?n2 ?s-size)
      (shot-bag-size ?s ?s-size))
    :effect (and
      (count-shot ?s ?h1 ?dc ingredient3 ?n0)
      ...
      (count-shot-goal ?s ingredient3 ?n0_1)
      (not (count-shot-goal ?s ingredient3 ?n1_1))
      (not (count-shot-goal-satisfied ?s ingredient3))
(increase (total-cost ) 1)))
(:action pour-shot-to-clean-shaker
    ...
    :effect (and
      ...
      (shaker-level ?d ?l1)
(increase (total-cost ) 1)))
(:action pour-shot-to-used-shaker-ingredient3-N
    :parameters (?s - shot ?d - shaker ?h1 - hand ?l - level ?l1 - level ?dc - object ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n0_1 - snum ?n1_1 - snum ?des - snum ?s-size - snum)
    :precondition (and
      (count-shot ?s ?h1 ?dc ingredient3 ?n1)
      (shot-less ?n0 ?n1)
    ...
    :effect (and
      ...
      (not (count-shot-goal ?s ingredient3 ?n1_1))
(increase (total-cost ) 1)))
(:action pour-shot-to-used-shaker-ingredient3-D
    :parameters (?s - shot ?d - shaker ?h1 - hand ?l - level ?l1 - level ?dc - object ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n0_1 - snum ?n1_1 - snum ?s-size - snum)
    :precondition (and
      (count-shot ?s ?h1 ?dc ingredient3 ?n1)
      (shot-less ?n0 ?n1)
...
(:action pour-shaker-to-shot-cocktail6-N
    ...
    :precondition (and
      ...
      (shot-less ?n0 ?n1)
      (count-shot ?d ?dc shot-property2-none cocktail6 ?n2)
      (shot-less ?n2 ?n3)
      (count-hand ?h ?s ?n4)
      (hand-less ?n5 ?n4)
      (shaked ?s)
      ...
      (next ?l1 ?l)
      (shot-less ?n2_1 ?n3_1)
      (count-shot-goal ?d cocktail6 ?n2_1)
      (not (= ?n3_1 ?des))
    ...
    :effect (and
      ...
      (count-shot ?d ?dc shot-property2-none cocktail6 ?n3)
      (not (count-shot ?d ?dc shot-property2-none cocktail6 ?n2))
      (shaker-level ?s ?l1)
      (not (shaker-level ?s ?l))
      (count-shot-goal ?d cocktail6 ?n3_1)
      (not (count-shot-goal ?d cocktail6 ?n2_1))
(increase (total-cost ) 1)))
(:action pour-shaker-to-shot-cocktail6-U
    ...
    :precondition (and
      ...
      (shot-less ?n2_1 ?n3_1)
      (count-shot-goal ?d cocktail6 ?n2_1)
      (count-shot-goal-desired-count ?d cocktail6 ?n3_1)
      (shot-lte-sum ?n1 ?n2 ?d-size)
      (shot-bag-size ?d ?d-size))
    :effect (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n0)
...
(increase (total-cost ) 1)))
(:action pour-shaker-to-shot-ingredient3-N
    :parameters (?d - shot ?h - hand ?s - shaker ?l - level ?l1 - level ?dc - object ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n2_1 - snum ?n3_1 - snum ?des - snum ?d-size - snum)
    :precondition (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n1)
      (shot-less ?n0 ?n1)
      (count-shot ?d ?dc shot-property2-none ingredient3 ?n2)
      (shot-less ?n2 ?n3)
      (count-hand ?h ?s ?n4)
      (hand-less ?n5 ?n4)
      (shaked ?s)
      (contains-shaker ?s ingredient3)
      (shaker-level ?s ?l)
      (next ?l1 ?l)
      (shot-less ?n2_1 ?n3_1)
      (count-shot-goal ?d ingredient3 ?n2_1)
      (not (= ?n3_1 ?des))
      (count-shot-goal-desired-count ?d ingredient3 ?des)
      (shot-lte-sum ?n1 ?n2 ?d-size)
      (shot-bag-size ?d ?d-size))
    :effect (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n0)
      (not (count-shot ?d ?dc clean-shot-true empty-shot-true ?n1))
      (count-shot ?d ?dc shot-property2-none ingredient3 ?n3)
      (not (count-shot ?d ?dc shot-property2-none ingredient3 ?n2))
      (shaker-level ?s ?l1)
      (not (shaker-level ?s ?l))
      (count-shot-goal ?d ingredient3 ?n3_1)
      (not (count-shot-goal ?d ingredient3 ?n2_1))
(increase (total-cost ) 1)))
(:action pour-shaker-to-shot-ingredient3-U
    :parameters (?d - shot ?h - hand ?s - shaker ?l - level ?l1 - level ?dc - object ?n1 - snum ?n0 - snum ?n2 - snum ?n3 - snum ?n4 - hnum ?n5 - hnum ?n2_1 - snum ?n3_1 - snum ?d-size - snum)
    :precondition (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n1)
      (shot-less ?n0 ?n1)
      ...
      (shot-less ?n2_1 ?n3_1)
      (count-shot-goal ?d ingredient3 ?n2_1)
      (count-shot-goal-desired-count ?d ingredient3 ?n3_1)
      (shot-lte-sum ?n1 ?n2 ?d-size)
      (shot-bag-size ?d ?d-size))
    :effect (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n0)
      ...
      (count-shot-goal ?d ingredient3 ?n3_1)
      (not (count-shot-goal ?d ingredient3 ?n2_1))
      (count-shot-goal-satisfied ?d ingredient3)
(increase (total-cost ) 1)))
