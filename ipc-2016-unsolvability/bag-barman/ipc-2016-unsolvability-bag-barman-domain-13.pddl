...
(:action shake
    ...
    :effect (and
      ...
      (contains-shaker ?s ?b)
(increase (total-cost ) 1)))
(:action fill-shot-ingredient1-N
    ...
    :precondition (and
      ...
      (shot-less ?n5 ?n4)
      (count-shot ?s ?h1 ingredient1 ingredient1 ?n6)
      (shot-less ?n6 ?n7)
      (dispenses ?d ingredient1)
      (shot-less ?n6_1 ?n7_1)
      (count-shot-goal ?s ingredient1 ?n6_1)
      (not (= ?n7_1 ?des))
      (count-shot-goal-desired-count ?s ingredient1 ?des)
      (shot-lte-sum ?n4 ?n6 ?s-size)
      (shot-bag-size ?s ?s-size))
    :effect (and
      (count-shot ?s ?h1 clean-shot-true empty-shot-true ?n5)
      (not (count-shot ?s ?h1 clean-shot-true empty-shot-true ?n4))
      (count-shot ?s ?h1 ingredient1 ingredient1 ?n7)
      (not (count-shot ?s ?h1 ingredient1 ingredient1 ?n6))
      (count-shot-goal ?s ingredient1 ?n7_1)
      (not (count-shot-goal ?s ingredient1 ?n6_1))
(increase (total-cost ) 10)))
(:action fill-shot-ingredient1-U
    ...
    :precondition (and
      ...
      (shot-less ?n6_1 ?n7_1)
      (count-shot-goal ?s ingredient1 ?n6_1)
      (count-shot-goal-desired-count ?s ingredient1 ?n7_1)
      (shot-lte-sum ?n4 ?n6 ?s-size)
      (shot-bag-size ?s ?s-size))
    :effect (and
      (count-shot ?s ?h1 clean-shot-true empty-shot-true ?n5)
      ...
      (count-shot-goal ?s ingredient1 ?n7_1)
      (not (count-shot-goal ?s ingredient1 ?n6_1))
      (count-shot-goal-satisfied ?s ingredient1)
(increase (total-cost ) 10)))
(:action fill-shot
    :parameters (?s - shot ?i - ingredient ?h1 - hand ?h2 - hand ?d - dispenser ?n1 - hnum ?n0 - hnum ?n2 - hnum ?n3 - hnum ?n4 - snum ?n5 - snum ?n6 - snum ?n7 - snum ?s-size - snum)
    :precondition (and
...
(increase (total-cost ) 1)))
(:action empty-shot-ingredient1-N
    :parameters (?h - hand ?p - shot ?n1 - hnum ?n0 - hnum ?dc - object ?n2 - snum ?n3 - snum ?n4 - snum ?n5 - snum ?n3_1 - snum ?n2_1 - snum ?des - snum ?p-size - snum)
    :precondition (and
      (count-hand ?h ?p ?n1)
      (hand-less ?n0 ?n1)
      (count-shot ?p ?h ?dc ingredient1 ?n2)
      (shot-less ?n3 ?n2)
      (count-shot ?p ?h ?dc empty-shot-true ?n4)
      (shot-less ?n4 ?n5)
      (shot-less ?n3_1 ?n2_1)
      (count-shot-goal ?p ingredient1 ?n2_1)
      (not (= ?n2_1 ?des))
      (count-shot-goal-desired-count ?p ingredient1 ?des)
      (shot-lte-sum ?n2 ?n4 ?p-size)
      (shot-bag-size ?p ?p-size))
    :effect (and
      (count-shot ?p ?h ?dc ingredient1 ?n3)
      (not (count-shot ?p ?h ?dc ingredient1 ?n2))
      (count-shot ?p ?h ?dc empty-shot-true ?n5)
      (not (count-shot ?p ?h ?dc empty-shot-true ?n4))
      (count-shot-goal ?p ingredient1 ?n3_1)
      (not (count-shot-goal ?p ingredient1 ?n2_1))
(increase (total-cost ) 1)))
(:action empty-shot-ingredient1-D
    :parameters (?h - hand ?p - shot ?n1 - hnum ?n0 - hnum ?dc - object ?n2 - snum ?n3 - snum ?n4 - snum ?n5 - snum ?n3_1 - snum ?n2_1 - snum ?p-size - snum)
    :precondition (and
      (count-hand ?h ?p ?n1)
      (hand-less ?n0 ?n1)
      ...
      (shot-less ?n3_1 ?n2_1)
      (count-shot-goal ?p ingredient1 ?n2_1)
      (count-shot-goal-desired-count ?p ingredient1 ?n2_1)
      (shot-lte-sum ?n2 ?n4 ?p-size)
      (shot-bag-size ?p ?p-size))
    :effect (and
      (count-shot ?p ?h ?dc ingredient1 ?n3)
      ...
      (count-shot-goal ?p ingredient1 ?n3_1)
      (not (count-shot-goal ?p ingredient1 ?n2_1))
      (not (count-shot-goal-satisfied ?p ingredient1))
(increase (total-cost ) 1)))
(:action empty-shot
    ...
    :effect (and
      ...
      (not (count-shot ?p ?h ?dc empty-shot-true ?n4))
(increase (total-cost ) 1)))
(:action pour-shot-to-clean-shaker-ingredient1-N
    ...
    :precondition (and
      (count-hand ?h1 ?s ?n1)
      (hand-less ?n0 ?n1)
      (count-shot ?s ?h1 ?dc ingredient1 ?n2)
      (shot-less ?n3 ?n2)
      ...
      (next ?l ?l1)
      (shot-less ?n3_1 ?n2_1)
      (count-shot-goal ?s ingredient1 ?n2_1)
      (not (= ?n2_1 ?des))
      (count-shot-goal-desired-count ?s ingredient1 ?des)
      (shot-lte-sum ?n2 ?n4 ?s-size)
      (shot-bag-size ?s ?s-size))
    :effect (and
      (count-shot ?s ?h1 ?dc ingredient1 ?n3)
      (not (count-shot ?s ?h1 ?dc ingredient1 ?n2))
      (count-shot ?s ?h1 ?dc empty-shot-true ?n5)
      (not (count-shot ?s ?h1 ?dc empty-shot-true ?n4))
      (contains-shaker ?d ingredient1)
      (not (empty-shaker ?d))
      (not (clean-shaker ?d))
      (unshaked ?d)
      (not (shaker-level ?d ?l))
      (shaker-level ?d ?l1)
      (count-shot-goal ?s ingredient1 ?n3_1)
      (not (count-shot-goal ?s ingredient1 ?n2_1))
(increase (total-cost ) 1)))
(:action pour-shot-to-clean-shaker-ingredient1-D
    ...
    :precondition (and
      ...
      (shot-less ?n3_1 ?n2_1)
      (count-shot-goal ?s ingredient1 ?n2_1)
      (count-shot-goal-desired-count ?s ingredient1 ?n2_1)
      (shot-lte-sum ?n2 ?n4 ?s-size)
      (shot-bag-size ?s ?s-size))
    :effect (and
      (count-shot ?s ?h1 ?dc ingredient1 ?n3)
      ...
      (count-shot-goal ?s ingredient1 ?n3_1)
      (not (count-shot-goal ?s ingredient1 ?n2_1))
      (not (count-shot-goal-satisfied ?s ingredient1))
(increase (total-cost ) 1)))
(:action pour-shot-to-clean-shaker
    ...
    :effect (and
      ...
      (shaker-level ?d ?l1)
(increase (total-cost ) 1)))
(:action pour-shot-to-used-shaker-ingredient1-N
    :parameters (?s - shot ?d - shaker ?h1 - hand ?l - level ?l1 - level ?n1 - hnum ?n0 - hnum ?dc - object ?n2 - snum ?n3 - snum ?n4 - snum ?n5 - snum ?n3_1 - snum ?n2_1 - snum ?des - snum ?s-size - snum)
    :precondition (and
      (count-hand ?h1 ?s ?n1)
      (hand-less ?n0 ?n1)
    ...
    :effect (and
      ...
      (not (count-shot-goal ?s ingredient1 ?n2_1))
(increase (total-cost ) 1)))
(:action pour-shot-to-used-shaker-ingredient1-D
    :parameters (?s - shot ?d - shaker ?h1 - hand ?l - level ?l1 - level ?n1 - hnum ?n0 - hnum ?dc - object ?n2 - snum ?n3 - snum ?n4 - snum ?n5 - snum ?n3_1 - snum ?n2_1 - snum ?s-size - snum)
    :precondition (and
      (count-hand ?h1 ?s ?n1)
      (hand-less ?n0 ?n1)
...
(increase (total-cost ) 1)))
(:action pour-shaker-to-shot-ingredient1-N
    :parameters (?d - shot ?h - hand ?s - shaker ?l - level ?l1 - level ?n1 - hnum ?n0 - hnum ?dc - object ?n2 - snum ?n3 - snum ?n4 - snum ?n5 - snum ?n4_1 - snum ?n5_1 - snum ?des - snum ?d-size - snum)
    :precondition (and
      (count-hand ?h ?s ?n1)
      (hand-less ?n0 ?n1)
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n2)
      (shot-less ?n3 ?n2)
      (count-shot ?d ?dc shot-property2-none ingredient1 ?n4)
      (shot-less ?n4 ?n5)
      (shaked ?s)
      (contains-shaker ?s ingredient1)
      (shaker-level ?s ?l)
      (next ?l1 ?l)
      (shot-less ?n4_1 ?n5_1)
      (count-shot-goal ?d ingredient1 ?n4_1)
      (not (= ?n5_1 ?des))
      (count-shot-goal-desired-count ?d ingredient1 ?des)
      (shot-lte-sum ?n2 ?n4 ?d-size)
      (shot-bag-size ?d ?d-size))
    :effect (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n3)
      (not (count-shot ?d ?dc clean-shot-true empty-shot-true ?n2))
      (count-shot ?d ?dc shot-property2-none ingredient1 ?n5)
      (not (count-shot ?d ?dc shot-property2-none ingredient1 ?n4))
      (shaker-level ?s ?l1)
      (not (shaker-level ?s ?l))
      (count-shot-goal ?d ingredient1 ?n5_1)
      (not (count-shot-goal ?d ingredient1 ?n4_1))
(increase (total-cost ) 1)))
(:action pour-shaker-to-shot-ingredient1-U
    :parameters (?d - shot ?h - hand ?s - shaker ?l - level ?l1 - level ?n1 - hnum ?n0 - hnum ?dc - object ?n2 - snum ?n3 - snum ?n4 - snum ?n5 - snum ?n4_1 - snum ?n5_1 - snum ?d-size - snum)
    :precondition (and
      (count-hand ?h ?s ?n1)
      (hand-less ?n0 ?n1)
      ...
      (shot-less ?n4_1 ?n5_1)
      (count-shot-goal ?d ingredient1 ?n4_1)
      (count-shot-goal-desired-count ?d ingredient1 ?n5_1)
      (shot-lte-sum ?n2 ?n4 ?d-size)
      (shot-bag-size ?d ?d-size))
    :effect (and
      (count-shot ?d ?dc clean-shot-true empty-shot-true ?n3)
      ...
      (count-shot-goal ?d ingredient1 ?n5_1)
      (not (count-shot-goal ?d ingredient1 ?n4_1))
      (count-shot-goal-satisfied ?d ingredient1)
(increase (total-cost ) 1)))
