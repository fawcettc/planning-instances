(define (problem prob)
 ...
 (:init
    ...
    (useable spanner102)
    (at spanner103 location20)
    (useable spanner103)
    (at spanner104 location45)
    (useable spanner104)
    (at spanner105 location49)
    (useable spanner105)
    (at spanner106 location48)
    (useable spanner106)
    (at spanner107 location31)
    (useable spanner107)
    (at spanner108 location5)
    (useable spanner108)
    (at spanner109 location56)
    (useable spanner109)
    (at spanner110 location52)
    (useable spanner110)
    (at spanner111 location19)
    (useable spanner111)
    (at spanner112 location20)
    (useable spanner112)
    (at spanner113 location59)
    (useable spanner113)
    (at spanner114 location7)
    (useable spanner114)
    (at spanner115 location5)
    (useable spanner115)
    (at spanner116 location70)
    (useable spanner116)
    (at spanner117 location61)
    (useable spanner117)
    (at spanner118 location39)
    (useable spanner118)
    (at spanner119 location62)
    (useable spanner119)
    (at spanner120 location50)
    (useable spanner120)
    (loose nut1)
    (at nut1 gate)
    (loose nut2)
