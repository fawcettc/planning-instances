(define (problem prob)
 ...
 (:init
    ...
    (useable spanner92)
    (at spanner93 location34)
    (useable spanner93)
    (at spanner94 location52)
    (useable spanner94)
    (at spanner95 location14)
    (useable spanner95)
    (at spanner96 location48)
    (useable spanner96)
    ...
    (useable spanner99)
    (at spanner100 location54)
    (useable spanner100)
    (at spanner101 location45)
    (useable spanner101)
    (at spanner102 location39)
    (useable spanner102)
    (at spanner103 location33)
    (useable spanner103)
    (at spanner104 location18)
    (useable spanner104)
    (at spanner105 location58)
    (useable spanner105)
