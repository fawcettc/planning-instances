(define (problem prob)
 ...
 (:init
    ...
    (useable spanner78)
    (at spanner79 location21)
    (useable spanner79)
    (at spanner80 location28)
    (useable spanner80)
    (at spanner81 location21)
    (useable spanner81)
    ...
    (useable spanner99)
    (at spanner100 location10)
    (useable spanner100)
    (at spanner101 location11)
    (useable spanner101)
    (at spanner102 location40)
    (useable spanner102)
    (at spanner103 location51)
    (useable spanner103)
    (at spanner104 location51)
    (useable spanner104)
