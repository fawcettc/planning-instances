(define (problem prob)
 ...
 (:init
    ...
    (useable spanner89)
    (at spanner90 location34)
    (useable spanner90)
    (at spanner91 location17)
    (useable spanner91)
    (at spanner92 location1)
    (useable spanner92)
