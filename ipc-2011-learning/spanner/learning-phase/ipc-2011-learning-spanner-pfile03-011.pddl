(define (problem prob)
 ...
 (:init
    ...
    (useable spanner78)
    (at spanner79 location70)
    (useable spanner79)
    (at spanner80 location68)
    (useable spanner80)
    (at spanner81 location67)
    (useable spanner81)
    ...
    (useable spanner100)
    (at spanner101 location64)
    (useable spanner101)
    (at spanner102 location12)
    (useable spanner102)
    (at spanner103 location70)
    (useable spanner103)
    (at spanner104 location39)
    (useable spanner104)
    (at spanner105 location40)
    (useable spanner105)
    (at spanner106 location43)
    (useable spanner106)
    (at spanner107 location21)
    (useable spanner107)
    ...
    (useable spanner111)
    (at spanner112 location55)
    (useable spanner112)
    (at spanner113 location7)
    (useable spanner113)
    ...
    (useable spanner116)
    (at spanner117 location26)
    (useable spanner117)
    (at spanner118 location15)
    (useable spanner118)
    (at spanner119 location15)
    (useable spanner119)
    (at spanner120 location68)
    (useable spanner120)
    (loose nut1)
    (at nut1 gate)
    (loose nut2)
