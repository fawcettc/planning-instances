(define (problem prob)
 ...
 (:init
    ...
    (useable spanner88)
    (at spanner89 location43)
    (useable spanner89)
    (at spanner90 location21)
    (useable spanner90)
    ...
    (useable spanner94)
    (at spanner95 location48)
    (useable spanner95)
    (at spanner96 location10)
    (useable spanner96)
    (at spanner97 location31)
    (useable spanner97)
    (at spanner98 location15)
    (useable spanner98)
    (at spanner99 location69)
    (useable spanner99)
    (at spanner100 location21)
    (useable spanner100)
