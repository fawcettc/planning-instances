(define (problem prob)
 ...
 (:init
    ...
    (useable spanner87)
    (at spanner88 location29)
    (useable spanner88)
    (at spanner89 location31)
    (useable spanner89)
    (at spanner90 location45)
    (useable spanner90)
    (at spanner91 location10)
    (useable spanner91)
    (at spanner92 location36)
    (useable spanner92)
    (at spanner93 location24)
    (useable spanner93)
    (at spanner94 location20)
    (useable spanner94)
    (at spanner95 location11)
    (useable spanner95)
    (at spanner96 location10)
    (useable spanner96)
    (at spanner97 location46)
    (useable spanner97)
    (at spanner98 location9)
    (useable spanner98)
    (at spanner99 location37)
    (useable spanner99)
