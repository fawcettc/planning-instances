(define   (problem parking)
  ...
  (:init
    (at-curb car_55)
    (at-curb-num car_55 curb_00)
    (behind-car car_25 car_55)
    (car-clear car_25)
    (at-curb car_21)
    ...
    (car-clear car_32)
    (at-curb car_49)
    (at-curb-num car_49 curb_06)
    (behind-car car_56 car_49)
    (car-clear car_56)
    (at-curb car_54)
    (at-curb-num car_54 curb_07)
    (behind-car car_18 car_54)
    (car-clear car_18)
    (at-curb car_08)
    ...
    (car-clear car_26)
    (at-curb car_48)
    (at-curb-num car_48 curb_15)
    (behind-car car_22 car_48)
    (car-clear car_22)
    (at-curb car_04)
    ...
    (car-clear car_36)
    (at-curb car_59)
    (at-curb-num car_59 curb_20)
    (behind-car car_38 car_59)
    (car-clear car_38)
    (at-curb car_15)
    ...
    (car-clear car_12)
    (at-curb car_01)
    (at-curb-num car_01 curb_25)
    (behind-car car_53 car_01)
    (car-clear car_53)
    (at-curb car_58)
    (at-curb-num car_58 curb_26)
    (behind-car car_33 car_58)
    (car-clear car_33)
    (at-curb car_46)
    ...
    (behind-car car_45 car_47)
    (car-clear car_45)
    (at-curb car_39)
    (at-curb-num car_39 curb_29)
...
; =========== INIT ===========
;  curb_00: car_55 car_25
;  curb_01: car_21 car_20
;  curb_02: car_24 car_27
;  curb_03: car_17 car_37
;  curb_04: car_14 car_05
;  curb_05: car_06 car_32
;  curb_06: car_49 car_56
;  curb_07: car_54 car_18
;  curb_08: car_08 car_00
;  curb_09: car_35 car_44
;  curb_10: car_30 car_29
;  curb_11: car_42 car_40
;  curb_12: car_19 car_02
;  curb_13: car_43 car_03
;  curb_14: car_41 car_26
;  curb_15: car_48 car_22
;  curb_16: car_04 car_31
;  curb_17: car_52 car_13
;  curb_18: car_16 car_23
;  curb_19: car_10 car_36
;  curb_20: car_59 car_38
;  curb_21: car_15 car_34
;  curb_22: car_28 car_09
;  curb_23: car_57 car_51
;  curb_24: car_11 car_12
;  curb_25: car_01 car_53
;  curb_26: car_58 car_33
;  curb_27: car_46 car_07
;  curb_28: car_47 car_45
;  curb_29: car_39 car_50
;  curb_30:
; ========== /INIT ===========
; =========== GOAL ===========
