(define   (problem parking)
  ...
  (:init
    ...
    (behind-car car_09 car_50)
    (car-clear car_09)
    (at-curb car_59)
    (at-curb-num car_59 curb_01)
    (behind-car car_28 car_59)
    (car-clear car_28)
    (at-curb car_19)
    ...
    (car-clear car_07)
    (at-curb car_55)
    (at-curb-num car_55 curb_10)
    (behind-car car_49 car_55)
    (car-clear car_49)
    (at-curb car_02)
    ...
    (car-clear car_32)
    (at-curb car_51)
    (at-curb-num car_51 curb_22)
    (behind-car car_23 car_51)
    (car-clear car_23)
    (at-curb car_52)
    (at-curb-num car_52 curb_23)
    ...
    (behind-car car_45 car_42)
    (car-clear car_45)
    (at-curb car_18)
    (at-curb-num car_18 curb_26)
    (behind-car car_58 car_18)
    (car-clear car_58)
    (at-curb car_33)
    (at-curb-num car_33 curb_27)
    (behind-car car_37 car_33)
    (car-clear car_37)
    (at-curb car_53)
    (at-curb-num car_53 curb_28)
    (behind-car car_27 car_53)
    (car-clear car_27)
    (at-curb car_06)
    (at-curb-num car_06 curb_29)
    (behind-car car_39 car_06)
    (car-clear car_39)
    (curb-clear curb_30)
  )
  (:goal
...
; =========== INIT ===========
;  curb_00: car_50 car_09
;  curb_01: car_59 car_28
;  curb_02: car_19 car_48
;  curb_03: car_14 car_00
;  curb_04: car_30 car_12
;  curb_05: car_04 car_10
;  curb_06: car_31 car_56
;  curb_07: car_38 car_46
;  curb_08: car_41 car_47
;  curb_09: car_26 car_07
;  curb_10: car_55 car_49
;  curb_11: car_02 car_01
;  curb_12: car_57 car_34
;  curb_13: car_22 car_20
;  curb_14: car_11 car_43
;  curb_15: car_17 car_40
;  curb_16: car_08 car_16
;  curb_17: car_44 car_35
;  curb_18: car_24 car_05
;  curb_19: car_15 car_29
;  curb_20: car_03 car_54
;  curb_21: car_21 car_32
;  curb_22: car_51 car_23
;  curb_23: car_52 car_13
;  curb_24: car_25 car_36
;  curb_25: car_42 car_45
;  curb_26: car_18 car_58
;  curb_27: car_33 car_37
;  curb_28: car_53 car_27
;  curb_29: car_06 car_39
;  curb_30:
; ========== /INIT ===========
; =========== GOAL ===========
